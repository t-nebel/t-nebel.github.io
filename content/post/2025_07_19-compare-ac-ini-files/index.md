...
lastmod: 2026-04-18 14:00:00+0000
image: header.jpg
categories:
    - audiocodes
toc: false
...
> **📢 Update - April 18, 2026:** Fixed mismatch due to wrong index handling in for example IPInboundManipulation section
...
## Fix splitted content in for example IP Inbound Manipulations (April 18, 2026)

The IPInboundManipulation section now correctly identifies the single actual difference: "1234[0,1]#" vs "1234[0,1,2]#" in DestUsernamePrefix — instead of spurious mismatches caused by the comma-splitting the quoted value.